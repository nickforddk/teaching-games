...
export default function App() {
  ...
  if (route === '/admin') {
    ...
    if (!authState.user)
      return (
        <div className="p-8 bg-white dark:bg-blue-900 rounded-lg shadow space-y-4 text-center my-auto">
          <h2 className="text-xl font-bold text-blue-800 dark:text-white">Gamemaster sign-in</h2>
          <button onClick={authState.login} className="py-3 px-4 rounded">
            Sign in with GitHub
          </button>
        </div>
      );
    ...
    <div className="bg-white dark:bg-blue-900 flex flex-col shadow rounded-lg p-4 md:p-6 w-full max-w-[1200px] space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        <input
          ...
          className="p-2 rounded w-full placeholder-shown:border-red-500 hover:placeholder-shown:border-red-700 dark:hover:placeholder-shown:border-red-300"
        />
        <input
